...
from .config_neumiss import NeuMissConfig
from .model import NeuMissModel


def build_dataloaders(config: NeuMissConfig):
...
def main() -> None:
    ...
    config = NeuMissConfig(dataset=dataset_cfg, training=training_cfg)

    seed_everything(config.training.seed)
    model = NeuMissModel(config)
