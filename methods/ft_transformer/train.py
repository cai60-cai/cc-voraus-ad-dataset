...
from .config_ft_transformer import FTTransformerConfig
from .model import FTTransformer


def build_dataloaders(config: FTTransformerConfig):
...
def main() -> None:
    ...
    training_cfg = TrainingConfig(learning_rate=8e-4)
    config = FTTransformerConfig(dataset=dataset_cfg, training=training_cfg)
